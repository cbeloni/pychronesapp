...
def index(chamado_id):
    ...
    organizar_id_ordem.acrescentar_um_para_id_ordem(int(item_dicionario['id_ordem']) - 1)
    organizar_id_ordem.diminuir_um_para_id_ordem(int(item_dicionario['id_ordem']))    
